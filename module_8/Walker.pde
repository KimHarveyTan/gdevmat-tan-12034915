...
{ 
   ...
   public PVector calculateAttraction(Walker walker)
   {
    ...
    distance = constrain(distance, 5, 25); // solves divide by 0 and divide by really tiny values, it that will multiply the distances by a huge amount and shoots it at incredible speeds (ex. x/0.00001 == x * 10000)
